...
public class Client {
    ...
    /**
     * Prompt for and return the desired color.
     */
        ...
        while (true) {
            ...
            if (line.startsWith("SUBMITNAME")) {
                ...
                out.println("OTHERPLAYER Name:" + name + "|X:" + player.getX() + "|Y:" + player.getY() +
                    "|Size:" + player.getSize() + "|Color:" + c + "|ID:" + player.getID());
                player.setColor(c);
                player.setName(name);
                ...
                if(panel.canAddPlayer(ID))
                    panel.addPlayer(new OtherPlayer(name, x, y, size, color, ID));
